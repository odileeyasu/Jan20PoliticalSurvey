...
levels(education$Education) <- list("No high school diploma" = c("Less than high school (Grades 1-8 or no formal schooling)",
                                                                        "High school incomplete (Grades 9-11 or Grade 12 with NO diploma)"),
                                    "High school diploma" = c("High school graduate (Grade 12 with diploma or GED certificate)",
