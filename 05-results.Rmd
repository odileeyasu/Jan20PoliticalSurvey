...
### *About Donald Trump as the President of the United States of America*

### *Other Controversial Societal Topics*
...
levels(opposes$Response)

ggplot() +
  likert_theme+
  geom_bar(data=supports, aes(x=Question, y=Prop, fill = Response),
           stat = "identity", position = "stack") +
  geom_bar(data=opposes, aes(x=Question, y=-Prop, fill = fct_rev(Response)),
           stat = "identity", position = "stack") +
  coord_flip() +
  ...
  ggtitle("\nDemocrats and Republicans exhibit opposing views on debating topics like \nfree tuition, Medicare, and death penalty",
          subtitle = "Replies to the question: Would you strongly favor, somewhat favor, somewhat oppose, or \nstrongly oppose each of the following question?\n\n")
```
