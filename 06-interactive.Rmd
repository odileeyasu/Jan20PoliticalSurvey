...
<script>
  ...
  svg.append("text")
    .text("In").attr("x","210").attr("y", "70")
    .attr("font-size", "20");
  
  svg.append("text")
  .text("' opinion,").attr("x","540").attr("y", "70")
  .attr("font-size", "20");
  
  svg.append("text")
  .text("are conflicts between ... very strong, strong, \nnot very strong, or there are not conflicts?")
    .attr("x","210").attr("y", "95")
    .attr("font-size", "20");
  ...
  options.append("text")
    .attr('id','dem')
    .attr("x","340").attr("y", "70")
    .text("Democrats");

  options.append("text")
    .attr('id','ind')
    .attr("x","432").attr("y", "70")
    .text("Independents");
