...
We also mention the limitations in our findings in the results chapter. The sample sizes of people coming from certain backgrounds (a particular race, a particular education level) are unbalanced. This would affect the authenticity of our analysis and conclusions. It is important to point out that, any analysis based on a larger, more balanced sample may be more reliable, and we should definitely consider switching to a different data source for relevant analysis in the future. Additionally, due to the fact that the dataset contains mostly interviews conducted through cell phones and only a small amount through landlines, there might be bias involved as we addressed in chapter 2. Despite the above problems with the dataset, the size of this sample is too small that largely impedes more diverse visualization methods such as linked map, as the samples in some states are too small.
